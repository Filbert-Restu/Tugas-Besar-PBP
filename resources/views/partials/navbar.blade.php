...
<nav x-data="{ isMobileMenuOpen: false, isSearchOpen: false }" class="bg-white shadow-sm">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            {{-- Search bar, hanya tampil di layar medium ke atas --}}
            ...
            {{-- Ikon user, keranjang, dan menu mobile --}}
            <div class="flex items-center space-x-5 h-full">
                ...
                <div class="relative group h-full content-center">
                    @if (Auth::check())
                    {{-- Ikon user --}}
                    <a href="{{ route('user.profile') }}" class="text-gray-600 hover:text-emerald-500">
                    ...
                    @else
                        {{-- button login --}}
                        <a href="{{ route('login') }}" class="bg-teal-500 hover:bg-teal-600 text-white px-3 py-1.5 rounded-lg font-semibold">
                            Masuk
                        </a>
                        {{-- button register --}}
                        <a href="{{ route('register') }}" class="bg-teal-500 hover:bg-teal-600 text-white px-3 py-1.5 rounded-lg font-semibold ml-2">
                            Daftar
                        </a>
                    @endif
                </div>
