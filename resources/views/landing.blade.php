...
<div class="text-center py-12">
    <h1 class="text-4xl font-bold text-blue-600 mb-4">Selamat Datang di UMKM Mini-Commerce</h1>
    <p class="text-gray-600 mb-6">Belanja produk UMKM lokal dengan mudah, aman, dan cepat.</p>
    <div class="space-x-4">
        ...
        @auth
            ...
            @else
                <a href="{{ route('user.dashboard') }}" class="bg-yellow-500 text-white px-4 py-2 rounded">Dashboard</a>
            @endif
        @endauth
    </div>
</div>
