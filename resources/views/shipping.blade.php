                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="mb-5 p-4 bg-gray-50 rounded-lg">
                        <div class="flex justify-between items-start">
                            ...
                            <a href="{{ route('checkout') }}" class="text-teal-600 hover:text-teal-700 font-medium text-xs">Edit</a>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between mt-6 pt-6 border-t">
                        <a href="{{ route('checkout') }}" class="text-teal-600 hover:text-teal-700 font-medium text-sm">
                            Kembali ke Detail
                        </a>
