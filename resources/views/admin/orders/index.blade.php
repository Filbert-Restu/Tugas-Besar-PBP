                ...
                <div class="flex items-center gap-4">
                  <div class="relative">
                    @if($item->product && $item->product->image)
                      <img src="{{ asset('storage/' . $item->product->image) }}" class="w-16 h-16 rounded-xl object-cover shadow-md border-2 border-gray-200">
                    @else
                      <div class="w-16 h-16 rounded-xl bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center shadow-md border-2 border-gray-200">
