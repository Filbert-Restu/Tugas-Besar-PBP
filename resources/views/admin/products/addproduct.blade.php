  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
      <div class="flex items-center gap-3 mb-2">
        <a href="{{ route('admin.products.index') }}" class="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-md hover:shadow-lg transition-shadow border border-gray-200">
    ...
    <form class="bg-white shadow-xl rounded-2xl p-8 space-y-6 border border-gray-100">
      ...
      <div class="flex flex-col sm:flex-row gap-3 pt-4">
        ...
        <a href="{{ route('admin.products.index') }}" class="flex-1 sm:flex-none px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-800 text-white rounded-xl shadow-lg hover:shadow-xl hover:from-gray-800 hover:to-gray-900 transition-all font-semibold flex items-center justify-center gap-2">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
